...
<head>
  ...
  <link href="{{asset('public/baclend/assets/plugins/perfect-scrollbar/css/perfect-scrollbar.css')}}" rel="stylesheet" />
          ...
          <!--navigation-->
           <ul class="metismenu" id="menu">
            ...
            <li>
                ...
                <ul>
                  <li> <a href="widgets-static-widgets.html"><i class="bi bi-circle"></i>Add Employe</a>
                  </li>
                  <li> <a href="widgets-data-widgets.html"><i class="bi bi-circle"></i>All Employe</a>
                  </li>
                </ul>
            </li>
            ...
            <li>
                ...
                <ul>
                  <li> <a href="widgets-static-widgets.html"><i class="bi bi-circle"></i>All  Category</a>
                  </li>
                  <li> <a href="widgets-data-widgets.html"><i class="bi bi-circle"></i>Add Category</a>
                  </li>
                </ul>
            </li>
